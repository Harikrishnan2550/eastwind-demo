...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Form routing logic loop hook space
    setSubmitted(true);
  };
        ...
        <div className="relative w-full overflow-hidden bg-slate-950 min-h-[50vh] pt-[250px] pb-32 flex items-center z-10 border-b border-slate-900 shrink-0">
          ...
          <div className="relative max-w-[1240px] w-full mx-auto px-6 z-20">
            ...
            <p className="text-lg text-slate-300 font-light leading-relaxed max-w-2xl m-0">
              Initiate technical scoping, request custom hardware estimations, or schedule compliance architecture audits with our Dammam team.
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-5 space-y-12">
              <div className="space-y-3">
                ...
                <h2 className="text-2xl font-bold text-slate-900 uppercase tracking-tight m-0">
                  Primary Operation Hubs
                </h2>
                <p className="text-sm text-slate-500 font-light leading-relaxed m-0">
                  Direct routing channels across our regional estimating centers, specialized equipment workshop cells, and corporate headquarters.
                </p>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-5 items-start">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wide m-0">Al Khobar Headquarters</h4>
                    <p className="text-xs text-slate-500 leading-relaxed font-light m-0">
                ...
                <div className="flex gap-5 items-start">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wide m-0">Riyadh Technology Hub</h4>
                    <p className="text-xs text-slate-500 leading-relaxed font-light m-0">
                ...
                <div className="border-t border-slate-100 pt-8 space-y-4">
                  <div className="flex items-center gap-4 text-xs text-slate-600 font-light">
                    ...
                    <span>General Correspondence: <a href="mailto:info@eastwindsafety.com" className="text-[#c22026] font-semibold no-underline hover:underline">info@eastwindsafety.com</a></span>
                  </div>
                  <div className="flex items-center gap-4 text-xs text-slate-600 font-light">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-400">
                      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                    </svg>
                    <span>Secure Telephone Exchange: <span className="text-slate-900 font-semibold">+966 13 889 XXXX</span></span>
                  </div>
                  <div className="flex items-center gap-4 text-xs text-slate-600 font-light">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-400">
                    ...
                    <span>Operational Availability: <span className="text-slate-900 font-medium">Sunday – Thursday | 08:00 – 17:00 AST</span></span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 bg-[#f8fafc] border border-slate-200/60 p-8 md:p-10 rounded-2xl shadow-2xs">
              {submitted ? (
                <div className="py-12 text-center space-y-4">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 uppercase tracking-wide m-0">Transmission Complete</h3>
                  <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed m-0 font-light">
                    Your infrastructure profile has been successfully parsed and channeled to our technical estimating group in Dammam. A specialist will follow up within 24 business hours.
                  </p>
                  <button 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="border-b border-slate-200/80 pb-4">
                    <h3 className="text-sm font-bold text-slate-400 uppercase tracking-widest m-0">Project Registration</h3>
                    <p className="text-lg font-bold text-slate-900 pt-0.5 m-0">Blueprint Specifications Intake</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-xs focus:border-[#1e3e8f] focus:outline-hidden transition-colors font-medium text-slate-800"
                    >
                      <option value="oil-gas">Onshore / Offshore Oil & Gas</option>
                      <option value="petrochemical">Downstream Petrochemical Infrastructure</option>
                      <option value="civil-defense">Civil Defense / Public Safety</option>
                      <option value="power-utilities">Utility Systems & Smart Energy Grids</option>
                      <option value="marine-offshore">Marine Engineering & Fleet Operations</option>
                    </select>
                  </div>
